function TechDiversityRace() {
  ...
  this.setup = function() {
   ...
   this.select.style('background-color', '#f0f0f0');  // Background color
  this.select.style('color', '#333');                 // Text color
  this.select.style('padding', '8px');                // Padding
  this.select.style('border', '1px solid #ccc');      // Border
  this.select.style('border-radius', '4px');          // Border radius


    // Set select position.
     this.select.position(500, 40);
